...
let tasks = [
  {
    title: "Hover over the 'Check' icon next to ToDo",
    notes: "",
    date: "",
    priority: "Low",
    status: "incomplete",
  ...
  {
    title: "Click the icon to collapse the sidebar!",
    notes: "",
    date: "",
    priority: "Low",
    status: "incomplete",
...
export function sidebarController() {
  ...
  function addSidebarHighlight(e) {
    e
      ...
      : document.querySelector("#inbox").classList.add("sidebar-selected");
  }
...
export function addTask() {
  window.addEventListener("click", (e) => {
    ...
    if (
      (e.target.id === "new-task-background" || e.target.id === "cancel-btn") &&
